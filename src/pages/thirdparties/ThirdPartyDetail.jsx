      ...
      <div className="rounded-xl bg-white p-4 sm:p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-1">
            <DetailInfoPanel
              title={t('thirdPartyDetail.info.title')}
            ...
            >
              <dl className="space-y-4 text-sm">
                <div>
                  <dt className="text-xs font-medium text-gray-500 uppercase">{t('thirdPartyDetail.info.id', 'ID')}</dt>
                  <dd className="mt-1 text-gray-900 font-mono">#{thirdParty.id}</dd>
                </div>
                <div>
                  <dt className="text-xs font-medium text-gray-500 uppercase">{t('thirdPartyDetail.info.name', 'Name')}</dt>
                  <dd className="mt-1 text-gray-900">{thirdParty.name || '—'}</dd>
                </div>
                <div>
