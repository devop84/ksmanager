  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (isEditing) {
        ...
        await sql`
          INSERT INTO services (name, description, category_id, base_price, currency, is_active)
          VALUES (${formData.name}, ${formData.description || null}, ${categoryIdValue}, ${basePriceValue}, ${formData.currency}, ${formData.is_active})
        `
      }
