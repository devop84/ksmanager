      ...
      <div className="rounded-xl bg-white p-4 sm:p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          <div className="xl:col-span-1">
            <DetailInfoPanel
              title={t('staffDetail.info.title')}
              onEdit={() => onEdit?.(staff)}
              onDelete={onDelete}
              user={user}
            >
              <dl className="space-y-4 text-sm">
                <div>
                  <dt className="text-xs font-medium text-gray-500 uppercase">{t('staffDetail.info.id', 'ID')}</dt>
                  <dd className="mt-1 text-gray-900 font-mono">#{staff.id}</dd>
                </div>
                <div>
                  <dt className="text-xs font-medium text-gray-500 uppercase">{t('staffDetail.info.fullname', 'Full Name')}</dt>
                  <dd className="mt-1 text-gray-900">{staff.fullname || '—'}</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd className="mt-1 text-gray-900 whitespace-pre-wrap">{staff.bankdetail || '—'}</dd>
                </div>
                <div>
