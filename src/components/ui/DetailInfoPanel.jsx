...
function DetailInfoPanel({
  ...
  const canEdit = canModifyFn(user)
        ...
        <div className="flex items-center gap-2">
          {onEdit && (
            <button
              ...
              title={t('detailInfoPanel.actions.edit', 'Edit')}
            >
          ...
          {onDelete && (
            <button
              ...
              title={deleting ? t('detailInfoPanel.actions.deleting', 'Deleting…') : t('detailInfoPanel.actions.delete', 'Delete')}
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
